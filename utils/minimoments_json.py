...
if __name__ == '__main__':
    ...
    label_csv_path = os.path.join(csv_dir_path, 'moments_categories.txt')
    train_csv_path = os.path.join(csv_dir_path, 'train.txt')
    val_csv_path = os.path.join(csv_dir_path, 'validate.txt')
    dst_json_path = os.path.join(csv_dir_path, 'moments.json')
